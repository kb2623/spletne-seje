select * 
	from ADDRESS
	order by IS_SERVER asc, ADDRESS asc, ID asc;
...
select USERSESSION.ID as SESSIONID, ADDRESS.ADDRESS as IP, URISTEAM.FILE, URIQUERYPAIR.VALUE as QUERYVALUE, 
		URIQUERYKEY.NAME as QUERYKEY, REQUEST.DATE, REQUEST.TIME, REQUEST.SIZE_OF_RESPONSE, PROTOCOL.PROTOCOL, PROTOCOL.VERSION, 
		REQUEST.STATUS_CODE
	from USERID
	...
	where ADDRESS.ADDRESS like '193.77.14.19'
