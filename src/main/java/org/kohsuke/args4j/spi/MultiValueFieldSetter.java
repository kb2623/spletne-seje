...
final class MultiValueFieldSetter implements Getter, Setter {
    ...
    public MultiValueFieldSetter(Object bean, Field f) {
        ...
        if(!List.class.isAssignableFrom(f.getType())) throw new IllegalAnnotationError(Messages.ILLEGAL_FIELD_SIGNATURE.format(f.getType()));
    }
    ...
    private void doAddValue(Object bean, Object value) throws IllegalAccessException {
        ...
        if(!(o instanceof List)) throw new IllegalAnnotationError(Messages.ILLEGAL_LIST.format(f));
