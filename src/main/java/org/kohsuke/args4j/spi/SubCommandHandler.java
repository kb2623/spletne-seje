...
public class SubCommandHandler extends OptionHandler<Object> {
    ...
    public SubCommandHandler(CmdLineParser parser, OptionDef option, Setter<Object> setter) {
        ...
        if (commands==null) throw new IllegalStateException("SubCommandHandler must be used with @SubCommands annotation");
    }
    ...
    protected Object subCommand(SubCommand c, final Parameters params) throws CmdLineException {
        ...
        CmdLineParser p = configureParser(subCmd);
    ...
    protected CmdLineParser configureParser(Object subCmd) {
    ...
    public String getDefaultMetaVariable() {
        ...
        rv.append("[");
        for (SubCommand sc : commands.value()) rv.append(sc.name()).append(" | ");
