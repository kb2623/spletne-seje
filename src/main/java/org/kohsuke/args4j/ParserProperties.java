...
public class ParserProperties {
    ...
    public ParserProperties withUsageWidth(int usageWidth) {
        if (usageWidth < 0) throw new IllegalArgumentException("Usage width is negative");
    ...
    static final Comparator<OptionHandler> DEFAULT_COMPARATOR = (o1, o2) -> o1.option.toString().compareTo(o2.option.toString());
}
