...
public class SqlJetTableDef implements ISqlJetTableDef {
    ...
    public String toString() {
        return String.valueOf(getPage()) + "/" + getRowId() + ": " + toSQL(false);
    }
    ...
    public String toSQL(boolean schemaStrict) {
        ...
        for (ISqlJetTableConstraint constraint : constraints) buffer.append(", ").append(constraint.toString());
