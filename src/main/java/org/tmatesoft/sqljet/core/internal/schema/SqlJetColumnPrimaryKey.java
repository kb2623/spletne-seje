...
public class SqlJetColumnPrimaryKey extends SqlJetColumnIndexConstraint implements ISqlJetColumnPrimaryKey {
    ...
    public String toString() {
        ...
        if (ascending == Boolean.TRUE) buffer.append(" ASC");
        if (ascending == Boolean.FALSE) buffer.append(" DESC");
        if (conflictAction != null) buffer.append(" ON CONFLICT ").append(conflictAction);
        if (autoincremented) buffer.append(" AUTOINCREMENT");
