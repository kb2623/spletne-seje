...
public class SqlJetBytesUtility {
    ...
    static int getInt(byte[] b, int off) {
        return ((b[off + 3] & BYTE_UNSIGNED_MASK)) | ((b[off + 2] & BYTE_UNSIGNED_MASK) << 8) | ((b[off + 1] & BYTE_UNSIGNED_MASK) << 16) | ((b[off] & BYTE_UNSIGNED_MASK) << 24);
    }

    static float getFloat(byte[] b, int off) {
        int i = ((b[off + 3] & BYTE_UNSIGNED_MASK)) | ((b[off + 2] & BYTE_UNSIGNED_MASK) << 8) | ((b[off + 1] & BYTE_UNSIGNED_MASK) << 16) + ((b[off] & BYTE_UNSIGNED_MASK) << 24);
