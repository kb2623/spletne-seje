...
public abstract class AbstractTextGraphics implements TextGraphics {
    ...
    protected AbstractTextGraphics() {
        ...
        this.shapeRenderer = new DefaultShapeRenderer(AbstractTextGraphics.this::setCharacter);
    }
    ...
    public TextGraphics setTabBehaviour(TabBehaviour tabBehaviour) {
        if(tabBehaviour != null) this.tabBehaviour = tabBehaviour;
        return this;
    }
    ...
    public TextGraphics drawImage(
        ...
        if (fromRow >= untilRow || fromColumn >= untilColumn) return this;
