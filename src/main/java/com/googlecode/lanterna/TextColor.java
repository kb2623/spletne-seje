...
public interface TextColor {
    ...
    class RGB implements TextColor {
        ...
        public RGB(int r, int g, int b) {
            if(r < 0 || r > 255) throw new IllegalArgumentException("RGB: r is outside of valid range (0-255)");
            if(g < 0 || g > 255) throw new IllegalArgumentException("RGB: g is outside of valid range (0-255)");
            if(b < 0 || b > 255) throw new IllegalArgumentException("RGB: b is outside of valid range (0-255)");
