...
public class TextInputDialog extends DialogWindow {
    ...
    TextInputDialog(
        ...
        buttonPanel.addComponent(new Button("OK", this::onOK).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER, true, false)));
