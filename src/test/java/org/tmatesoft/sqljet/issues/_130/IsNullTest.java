...
public class IsNullTest extends AbstractNewDbTest {
    ...
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS beans (id INTEGER PRIMARY KEY AUTOINCREMENT, note TEXT)";
    ...
    public void testIsNull() throws Exception {
        db.runTransaction(db1 -> {
            ISqlJetTable table = db1.getTable("beans");
