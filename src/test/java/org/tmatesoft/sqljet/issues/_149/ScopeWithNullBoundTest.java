...
public class ScopeWithNullBoundTest extends AbstractNewDbTest {
    ...
    public void testScopeWithNullBound() throws SqlJetException {
        ...
        List<Long> upValues = Arrays.asList((long) 5, (long) 6, (long) 7);
        List<Long> downValues = Arrays.asList((long) 1, (long) 2, (long) 3, (long) 4, (long) 5);
        List<Long> upValuesExclusive = Arrays.asList((long) 6, (long) 7);
        List<Long> downValuesExclusive = Arrays.asList((long) 1, (long) 2, (long) 3, (long) 4);
