...
public class StatelessGetRowCoutTest extends AbstractNewDbTest {
    ...
    public void testRowCountIsStateless() throws SqlJetException {
        db.runReadTransaction(db1 -> {
            ...
            ISqlJetCursor cursor = db1.getTable("table").scope("names_idx", scope);
            ...
            cursor = db1.getTable("table").scope("names_idx", scope);
            // now at 0.
    ...
    public void testRowCountIsStatelessWhenIndexIsNotUnique() throws SqlJetException {
        db.runReadTransaction(db1 -> {
            ...
            ISqlJetCursor cursor = db1.getTable("pairs").scope("pairs_idx", scope);
