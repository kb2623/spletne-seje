...
public class SqlJetBenchmark extends AbstractBenchmark {
    ...
    public void selectAll() throws Exception {
        measure("SqlJetBenchmark.selectAll", () -> db.runReadTransaction(db1 -> {
    ...
    public void updateAll() throws Exception {
        measure("SqlJetBenchmark.updateAll", () -> db.runWriteTransaction(db1 -> {
            final ISqlJetCursor c = table.open();
            try {
    ...
    public void deleteAll() throws Exception {
        measure("SqlJetBenchmark.deleteAll", () -> db.runWriteTransaction(db1 -> {
            final ISqlJetCursor c = table.open();
            try {
                do {
                    if (!c.isNull(0)) {
    ...
    public void insertRandoms() throws Exception {
        measure("SqlJetBenchmark.insertRandoms", () -> db.runWriteTransaction(db1 -> {
    ...
    public void clear() throws Exception {
        measure("SqlJetBenchmark.clear", () -> db.runWriteTransaction(db1 -> {
            table.clear();
            return null;
        }));
    }
    ...
    public void locate() throws Exception {
        measure("SqlJetBenchmark.locate", () -> db.runReadTransaction(db1 -> {
            for (int i = 0; i < COUNT; i++) {
