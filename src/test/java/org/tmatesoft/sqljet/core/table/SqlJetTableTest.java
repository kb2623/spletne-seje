...
public class SqlJetTableTest extends AbstractDataCopyTest {
    ...
    public static final String DB = SqlJetUtility.getSysProp(TABLE_TEST + ".DB", ClassLoader.getSystemResource("data/db/testdb.sqlite").getFile());

    public static final String DB2 = SqlJetUtility.getSysProp(TABLE_TEST + ".DB", ClassLoader.getSystemResource("data/db/test2.sqlite").getFile());
    public static final String DB3 = SqlJetUtility.getSysProp(TABLE_TEST + ".DB", ClassLoader.getSystemResource("data/db/test3.sqlite").getFile());
    ...
    public static final String REP_CACHE_DB = SqlJetUtility.getSysProp(TABLE_TEST + ".REP_CACHE_DB", ClassLoader.getSystemResource("data/db/rep-cache/rep-cache.db").getFile());
