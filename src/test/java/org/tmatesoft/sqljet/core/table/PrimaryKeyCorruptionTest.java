...
public class PrimaryKeyCorruptionTest extends AbstractNewDbTest {
    ...
    public void testInsertCorruptsTable() throws SqlJetException {
        ...
        db.runTransaction(db1 -> {
            final ISqlJetCursor twoRows = db1.getTable("NODES").lookup(null, new Object[] {1, "A/D/gamma", 0});
            try {
    ...
    private long insertRow(final String tableName, Object... row) throws SqlJetException {
        ...
        final Long rowId = (Long) db.runTransaction(db1 -> db1.getTable(tableName).insertByFieldNamesOr(SqlJetConflictAction.REPLACE, values), SqlJetTransactionMode.WRITE);
