...
public class IndexOrderTest extends AbstractNewDbTest {
    ...
    public void setUp() throws Exception {
        ...
        db.runWriteTransaction(db1 -> {
            ...
            db1.createTable("create table t(a integer primary key, b integer, c integer)");
            db1.createIndex("create index b on t(b)");
            db1.createIndex("create index cb on t(c,b)");
            db1.createIndex("create index cd on t(c desc)");
            ...
            db1.createTable("create table t1(a integer, b integer, primary key (a,b))");
