...
public class UpdateMissedFieldsTest extends AbstractNewDbTest {
    ...
    private final static Map<String, Object> B = Collections.singletonMap("b", (Object) (long) 10);
    ...
    public void testUpdate() throws SqlJetException {
        doOperationTest(cursor -> cursor.update());
    }

    @Test
    public void testUpdateOr() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateOr(SqlJetConflictAction.REPLACE));
    }

    @Test
    public void testUpdateWithRowId() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateWithRowId(cursor.getRowId()));
    }

    @Test
    public void testUpdateWithRowIdOr() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateWithRowIdOr(SqlJetConflictAction.REPLACE, cursor.getRowId()));
    }

    @Test
    public void testUpdateByFieldNames() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNames(EMPTY));
    }

    @Test
    public void testUpdateByFieldNamesOr() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNamesOr(SqlJetConflictAction.REPLACE, EMPTY));
    }

    @Test
    public void testUpdateB() throws SqlJetException {
        doOperationTest(cursor -> cursor.update(cursor.getRowId(), 10));
    }

    @Test
    public void testUpdateOrB() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateOr(SqlJetConflictAction.REPLACE, 10));
    }

    @Test
    public void testUpdateWithRowIdB() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateWithRowId(cursor.getRowId(), 10));
    }

    @Test
    public void testUpdateWithRowIdOrB() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateWithRowIdOr(SqlJetConflictAction.REPLACE, cursor.getRowId(), 10));
    }

    @Test
    public void testUpdateByFieldNamesB() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNames(B));
    }

    @Test
    public void testUpdateByFieldNamesOrB() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNamesOr(SqlJetConflictAction.REPLACE, B));
    }

    @Test
    public void testUpdateByFieldNamesC() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNames(C));
    }

    @Test
    public void testUpdateByFieldNamesOrC() throws SqlJetException {
        doOperationTest(cursor -> cursor.updateByFieldNamesOr(SqlJetConflictAction.REPLACE, C));
    }
