...
public class SqlJetFileMockTest extends SqlJetAbstractFileSystemMockTest {
    ...
    public void testLockSharedThreads() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file2.lock(SqlJetLockType.SHARED));
        Assert.assertTrue(lock2.get());
    }

    @Test
    public void testLockReservedThreads() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED) && file.lock(SqlJetLockType.RESERVED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file2.lock(SqlJetLockType.SHARED) && file2.lock(SqlJetLockType.RESERVED));
    ...
    public void testLockExclusiveThreads() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file2.lock(SqlJetLockType.SHARED) && file2.lock(SqlJetLockType.RESERVED) && file2.lock(SqlJetLockType.EXCLUSIVE));
        Assert.assertFalse(lock2.get());
    }
    ...
    public void testLockCheckReservedThreads() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED) && file.lock(SqlJetLockType.RESERVED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(file2::checkReservedLock);
        Assert.assertTrue(lock2.get());
    }
    ...
    public void testLockSharedThreads2() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file.lock(SqlJetLockType.SHARED));
        Assert.assertTrue(lock2.get());
    }
    ...
    public void testLockReservedThreads2() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED) && file.lock(SqlJetLockType.RESERVED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file.lock(SqlJetLockType.SHARED) && file2.lock(SqlJetLockType.RESERVED));
        Assert.assertFalse(lock2.get());
    }
    ...
    public void testLockExclusiveThreads2() throws Exception {
        ...
        lock.get();
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(() -> file2.lock(SqlJetLockType.SHARED) && file2.lock(SqlJetLockType.RESERVED) && file.lock(SqlJetLockType.EXCLUSIVE));
        Assert.assertFalse(lock2.get());
    }
    ...
    public void testLockCheckReservedThreads2() throws Exception {
        final Future<Boolean> lock = execThread(() -> file.lock(SqlJetLockType.SHARED) && file.lock(SqlJetLockType.RESERVED));
        Assert.assertTrue(lock.get());
        final Future<Boolean> lock2 = execThread(file::checkReservedLock);
        Assert.assertTrue(lock2.get());
    }
