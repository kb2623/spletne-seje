...
public class SqlJetPagerTest extends SqlJetAbstractLoggedTest {
    ...
    public final void testWriteTemp() throws Exception {
        pager.open(fileSystem, null, null, SqlJetFileType.TEMP_DB, SqlJetUtility.of(SqlJetFileOpenPermission.CREATE, SqlJetFileOpenPermission.DELETEONCLOSE, SqlJetFileOpenPermission.READWRITE));
    ...
    public final void testWriteMain() throws Exception {
        pager.open(fileSystem, file, null, SqlJetFileType.MAIN_DB, SqlJetUtility.of(SqlJetFileOpenPermission.CREATE, SqlJetFileOpenPermission.READWRITE));
    ...
    public final void testWriteMemory() throws Exception {
        pager.open(fileSystem, new File(ISqlJetPager.MEMORY_DB), null, SqlJetFileType.MAIN_DB, SqlJetUtility.of(SqlJetFileOpenPermission.CREATE, SqlJetFileOpenPermission.READWRITE));
        final ISqlJetPage page = pager.acquirePage(1, true);
        pager.begin(true);
        page.write();
        SqlJetUtility.memset(page.getData(), (byte) 1, pager.getPageSize());
