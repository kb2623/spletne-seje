...
public class Svn17To18UpgradeTest extends AbstractDataCopyTest {
    ...
    private static final String DB = ClassLoader.getSystemResource("data/db/svn1.7/wc17.db").getFile();
    ...
    public void testUpgrade() throws IOException, SqlJetException {
        ...
        try {
            ...
            final ISqlJetCursor cursor = db.getTable("NODES").lookup(null, (long) 1);
