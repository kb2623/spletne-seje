...
public class Svn18SchemaTest extends AbstractNewDbTest {
    ...
    public void createSVN18WcDb() throws SqlJetException {
        ...
        schema.getTableNames().stream().filter(tableName -> !tableName.startsWith("sqlite_")).forEach(tableName -> Assert.assertTrue("No table '" + tableName + "'", tableNames.remove(tableName)));
