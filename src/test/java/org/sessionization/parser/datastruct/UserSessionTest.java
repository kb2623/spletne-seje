...
public class UserSessionTest {
	...
	public void testTimePoint() throws Exception {
		...
		assertNotNull(uS1);
		assertEquals("Address{id=null, serverAddress=false, address=/157.55.39.19} RemoteLogname{id=null, logname='-'} RemoteUser{id=null, user='-'} [PageViewAbs{id=null, requests=[DateTime{date=2014-06-26, time=04:44:51} RequestLine{method=Method{GET}, steamQuery=UriSteamQuery{id=null, uriSteam=UriSteam{id=null, file='/jope-puloverji/moski-pulover-b74-red'}, query=UriQuery{id=null, pairs=[UriQueryPair{id=null, value='18', key=UriQueryKey{id=null, name='limit'}}]}}, protocol=Protocol{id=null, protocol='HTTP', version=1.1}} StatusCode{status=200} SizeOfResponse{size=9545}]}]", uS1.toString());
		assertNotNull(uS2);
		assertEquals("Address{id=null, serverAddress=false, address=/157.55.39.19} RemoteLogname{id=null, logname='-'} RemoteUser{id=null, user='-'} [PageViewAbs{id=null, requests=[DateTime{date=2014-06-28, time=04:44:51} RequestLine{method=Method{GET}, steamQuery=UriSteamQuery{id=null, uriSteam=UriSteam{id=null, file='/jope-puloverji/gtk-3.0.css'}, query=UriQuery{id=null, pairs=[UriQueryPair{id=null, value=' ', key=UriQueryKey{id=null, name=' '}}]}}, protocol=Protocol{id=null, protocol='HTTP', version=1.1}} StatusCode{status=200} SizeOfResponse{size=9545}]}]", uS2.toString());
	...
	public void testAddParsedLine() throws Exception {
		...
		assertEquals("Address{id=null, serverAddress=false, address=/157.55.39.19} RemoteLogname{id=null, logname='-'} RemoteUser{id=null, user='-'} [PageViewAbs{id=null, requests=[DateTime{date=2014-06-26, time=04:44:51} RequestLine{method=Method{GET}, steamQuery=UriSteamQuery{id=null, uriSteam=UriSteam{id=null, file='/jope-puloverji/moski-pulover-b74-red'}, query=UriQuery{id=null, pairs=[UriQueryPair{id=null, value='18', key=UriQueryKey{id=null, name='limit'}}]}}, protocol=Protocol{id=null, protocol='HTTP', version=1.1}} StatusCode{status=200} SizeOfResponse{size=9545}, DateTime{date=2014-06-28, time=04:44:51} RequestLine{method=Method{GET}, steamQuery=UriSteamQuery{id=null, uriSteam=UriSteam{id=null, file='/jope-puloverji/gtk-3.0.css'}, query=UriQuery{id=null, pairs=[UriQueryPair{id=null, value=' ', key=UriQueryKey{id=null, name=' '}}]}}, protocol=Protocol{id=null, protocol='HTTP', version=1.1}} StatusCode{status=200} SizeOfResponse{size=9545}]}, PageViewAbs{id=null, requests=[DateTime{date=2014-06-28, time=04:46:23} RequestLine{method=Method{GET}, steamQuery=UriSteamQuery{id=null, uriSteam=UriSteam{id=null, file='/jope-puloverji/moski-pulover-b74-red'}, query=UriQuery{id=null, pairs=[UriQueryPair{id=null, value='18', key=UriQueryKey{id=null, name='limit'}}]}}, protocol=Protocol{id=null, protocol='HTTP', version=1.1}} StatusCode{status=200} SizeOfResponse{size=9545}]}]", uSession.toString());
	}
}