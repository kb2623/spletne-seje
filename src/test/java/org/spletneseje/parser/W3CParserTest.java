...
import org.spletneseje.fields.w3c.Date;
import org.spletneseje.fields.w3c.MetaData;
...
public class W3CParserTest {
    ...
    public void testParseLineFileOne() {
        try {
            parser.openFile(ClassLoader.getSystemResource(pathW3C + "ex080814.log").getFile());
