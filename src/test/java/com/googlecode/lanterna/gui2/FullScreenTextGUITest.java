...
public class FullScreenTextGUITest {
    ...
    private static class BIOS extends Panel {
        ...
        private BIOS() {
            ...
            Arrays.asList(button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, button13, button14).forEach(this::addComponent);
