...
public class PropertiesThemeTest {
    ...
    public void defaultThemeWorks() throws IOException {
        InputStream inputStream = ClassLoader.getSystemResourceAsStream("default-theme.properties");
        Properties properties = new Properties();
        ...
        assertEquals(Arrays.asList(SGR.BOLD), new ArrayList<>(defaultDefinition.getSelected().getSGRs()));
    }
