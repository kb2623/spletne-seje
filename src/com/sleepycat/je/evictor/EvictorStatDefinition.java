...
public class EvictorStatDefinition {
    ...
    public static final StatDefinition MIXED_LRU_SIZE =
        new StatDefinition("lruMixedSize",
                           "Number of INs in the mixed LRU ",
                           StatType.CUMULATIVE);

    public static final StatDefinition DIRTY_LRU_SIZE =
        new StatDefinition("lruDirtySize",
                           "Number of INs in the dirty LRU ",
                           StatType.CUMULATIVE);
}
